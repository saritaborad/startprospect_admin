...
export default function SignupBusiness() {
	...
	const submitBusinessRagister = async (data, resetForm) => {
	...
	const submitBusinessRagisterBySocial = async (data, resetForm) => {
									...
									<div>
										...
										{socialLoginPopUp ? (
											<Formik
												...
												onSubmit={(formData, { resetForm }) => submitBusinessRagisterBySocial(formData, resetForm)}
											>
												{(runform) => (
													<form className="row align-items-center px-sm-5 px-3" onSubmit={runform.handleSubmit}>
														...
														<div className="col-lg-6 col-md-12 col-sm-6 mb-3">
															<label className="comn-label-class">Company Name</label>
															<bdi className="d-block position-relative">
																<input type="text" name="company" className="form-control comn-input-style" placeholder="Enter Your Company Name" {...formAttr(runform, "company")} />
																<span className="comn-left-input-icon">
															...
															{errorContainer(runform, "company")}
														</div>
														<div className="col-lg-6 col-md-12 col-sm-6 mb-3">
														...
														<div className="col-lg-6 col-md-12 col-sm-6 mb-3">
															...
															<bdi className="d-block position-relative">
																<input type="email" disabled name="email" className="form-control comn-input-style" placeholder="Enter Your Email" {...formAttr(runform, "email")} />
																<span className="comn-left-input-icon">
																	<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<Formik
												...
												onSubmit={(formData, { resetForm }) => {
													submitBusinessRagister(formData, resetForm);
												}}
											>
												{(runform) => (
													<form className="row align-items-center px-sm-5 px-3" onSubmit={runform.handleSubmit}>
														...
														<div className="col-lg-6 col-md-12 col-sm-6 mb-3">
															<label className="comn-label-class">Email Address</label>
															<bdi className="d-block position-relative">
																<input type="email" name="email" className="form-control comn-input-style" placeholder="Enter Your Email" {...formAttr(runform, "email")} />
																<span className="comn-left-input-icon">
																	<svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
																		<path d="M18 16H2C0.89543 16 0 15.1046 0 14V1.913C0.0466084 0.842548 0.928533 -0.00101238 2 9.11911e-07H18C19.1046 9.11911e-07 20 0.895432 20 2V14C20 15.1046 19.1046 16 18 16ZM2 3.868V14H18V3.868L10 9.2L2 3.868ZM2.8 2L10 6.8L17.2 2H2.8Z" fill="#7B838A" />
																	</svg>
														...
														<div className="col-lg-6 col-md-12 col-sm-6 mb-3">
															...
															<bdi className="d-block position-relative">
																<input type={showPassword} name="password" id="password" className="form-control comn-input-style pe-5" placeholder="Enter Your Password" {...formAttr(runform, "password")} />
																<span className="comn-left-input-icon">
